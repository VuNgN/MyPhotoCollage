...
public class FilterUtils {
    public static final FilterBean[] EFFECT_CONFIGS = {new FilterBean("", "Original"), new FilterBean("@adjust lut filters/lomo1.webp", "Lomo 01"), new FilterBean("@adjust lut filters/lomo2.webp", "Lomo 02"), new FilterBean("@adjust lut filters/lomo3.webp", "Lomo 03"), new FilterBean("@adjust lut filters/lomo4.webp", "Lomo 04"), new FilterBean("@adjust lut filters/lomo5.webp", "Lomo 05"), new FilterBean("@adjust lut filters/portrait_film.png", "Portrait Film"), new FilterBean("@adjust lut filters/cali_vibes.png", "Cali Vibes"), new FilterBean("@adjust lut filters/arctic_chill.png", "Arctic Chill"), new FilterBean("@adjust lut filters/vibrant_light.png", "Vibrant Light"), new FilterBean("@adjust lut filters/binary_code.png", "Binary Code"), new FilterBean("@adjust lut filters/soft_fade.png", "Soft Fade"), new FilterBean("@adjust lut filters/lush_land.png", "Lush Land"), new FilterBean("@adjust lut filters/hdr_color.png", "HDR Color"), new FilterBean("@adjust lut filters/warm_teal.png", "Warm Teal"), new FilterBean("@adjust lut filters/hollywood.png", "Hollywood"), new FilterBean("@adjust lut filters/kodak_color.png", "Kodak Color"), new FilterBean("@adjust lut filters/euro01.webp", "Euro 01"), new FilterBean("@adjust lut filters/euro02.webp", "Euro 02"), new FilterBean("@adjust lut filters/euro05.webp", "Euro 03"), new FilterBean("@adjust lut filters/euro04.webp", "Euro 04"), new FilterBean("@adjust lut filters/euro06.webp", "Euro 05"), new FilterBean("@adjust lut filters/film01.webp", "Film 01"), new FilterBean("@adjust lut filters/film02.webp", "Film 02"), new FilterBean("@adjust lut filters/film03.webp", "Film 03"), new FilterBean("@adjust lut filters/film04.webp", "Film 04"), new FilterBean("@adjust lut filters/film05.webp", "Film 05"), new FilterBean("@adjust lut filters/bright01.webp", "Fresh 01"), new FilterBean("@adjust lut filters/bright02.webp", "Fresh 02"), new FilterBean("@adjust lut filters/bright03.webp", "Fresh 03"), new FilterBean("@adjust lut filters/bright05.webp", "Fresh 05"), new FilterBean("@adjust lut filters/movie01.webp", "Movie 01"), new FilterBean("@adjust lut filters/movie02.webp", "Movie 02"), new FilterBean("@adjust lut filters/movie03.webp", "Movie 03"), new FilterBean("@adjust lut filters/movie04.webp", "Movie 04"), new FilterBean("@adjust lut filters/movie05.webp", "Movie 05"), new FilterBean("@adjust lut filters/cube1.jpg", "Cube 1"), new FilterBean("@adjust lut filters/cube2.jpg", "Cube 2"), new FilterBean("@adjust lut filters/cube3.jpg", "Cube 3"), new FilterBean("@adjust lut filters/cube4.jpg", "Cube 4"), new FilterBean("@adjust lut filters/cube5.jpg", "Cube 5"), new FilterBean("@adjust lut filters/cube6.jpg", "Cube 6"), new FilterBean("@adjust lut filters/cube7.jpg", "Cube 7"), new FilterBean("@adjust lut filters/cube8.jpg", "Cube 8"), new FilterBean("@adjust lut filters/cube9.jpg", "Cube 9"), new FilterBean("@adjust lut filters/cube10.jpg", "Cube 10")};
