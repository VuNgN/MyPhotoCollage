...
public class FilterDialogFragment extends DialogFragment implements FilterListener {
    ...
    public View onCreateView(@NonNull LayoutInflater layoutInflater, @Nullable ViewGroup viewGroup, @Nullable Bundle bundle) {
        ...
        this.rvFilterView.setAdapter(new FilterViewAdapter(this.lstFilterBitmap, this, getContext(), Arrays.asList(com.sutech.photoeditor.editor.filterscolor.FilterUtils.EFFECT_CONFIGS)));
