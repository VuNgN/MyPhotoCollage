package com.sutech.photoeditor.editor.featuresfoto.addtext;
...
import com.sutech.photoeditor.editor.featuresfoto.CarouselPicker;
import com.sutech.photoeditor.editor.featuresfoto.addtext.adapter.FontAdapter;
import com.sutech.photoeditor.editor.featuresfoto.addtext.adapter.ShadowAdapter;
import com.sutech.photoeditor.util.FontUtils;
import com.sutech.photoeditor.util.SharePreferenceUtil;
...
public class TextEditorDialogFragment extends DialogFragment implements View.OnClickListener, FontAdapter.ItemClickListener, ShadowAdapter.ShadowItemClickListener {
    ...
    public com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties addTextProperties;
    ...
    com.sutech.photoeditor.editor.featuresfoto.addtext.CustomEditText mAddTextEditText;
    ...
    public interface TextEditor {
        ...
        void onDone(com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties addTextProperties);
    }
    ...
    public void onShadowItemClick(View view, int i) {
        com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties.TextShadow textShadow = com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties.getLstTextShadow().get(i);
    ...
    public static TextEditorDialogFragment show(@NonNull AppCompatActivity appCompatActivity, com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties addTextProperties2) {
        TextEditorDialogFragment textEditorDialogFragment = new TextEditorDialogFragment();
    ...
    public void setAddTextProperties(com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties addTextProperties2) {
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle bundle) {
        ...
        if (this.addTextProperties == null) {
            this.addTextProperties = com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties.getDefaultProperties();
        }
        ...
        this.shadowAdapter = new ShadowAdapter(getContext(), com.sutech.photoeditor.editor.featuresfoto.addtext.AddTextProperties.getLstTextShadow());
