...
public interface PuzzleLayout {
    ...
    com.sutech.photoeditor.editor.featuresfoto.puzzle.Area getArea(int i);

    int getAreaCount();

    int getColor();

    List<com.sutech.photoeditor.editor.featuresfoto.puzzle.Line> getLines();

    Area getOuterArea();

    List<com.sutech.photoeditor.editor.featuresfoto.puzzle.Line> getOuterLines();
    ...
    public static class Info implements Parcelable {
        ...
        public ArrayList<com.sutech.photoeditor.editor.featuresfoto.puzzle.Line> lines;
    ...
    public static class Step implements Parcelable {
        ...
        public com.sutech.photoeditor.editor.featuresfoto.puzzle.Line.Direction lineDirection() {
            return this.direction == 0 ? com.sutech.photoeditor.editor.featuresfoto.puzzle.Line.Direction.HORIZONTAL : com.sutech.photoeditor.editor.featuresfoto.puzzle.Line.Direction.VERTICAL;
        }
