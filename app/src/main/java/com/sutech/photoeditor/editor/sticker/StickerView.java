package com.sutech.photoeditor.editor.sticker;
...
public class StickerView extends RelativeLayout {
    ...
    private com.sutech.photoeditor.editor.sticker.Sticker handlingSticker;
    private final List<BitmapStickerIcon> icons;
    private long lastClickTime;
    private com.sutech.photoeditor.editor.sticker.Sticker lastHandlingSticker;
    ...
    private final List<com.sutech.photoeditor.editor.sticker.Sticker> stickers;
    ...
    public interface OnStickerOperationListener {
        void onStickerAdded(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerClicked(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerDeleted(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerDoubleTapped(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerDragFinished(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerFlipped(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerTouchOutside();

        void onStickerTouchedDown(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);

        void onStickerZoomFinished(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker);
       ...
       final int[] StickerView = {R.attr.borderAlpha, R.attr.borderColor, R.attr.bringToFrontCurrentSticker, R.attr.showBorder, R.attr.showIcons};
        ...
        try {
            ...
            try {
                ...
                this.borderPaint.setColor(typedArray.getColor(1, Color.parseColor("#040404")));
    ...
    public List<com.sutech.photoeditor.editor.sticker.Sticker> getStickers() {
        return this.stickers;
    }

    public void configDefaultIcons() {
        BitmapStickerIcon iconRemove = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_close_white_18dp), 0, BitmapStickerIcon.REMOVE);
        iconRemove.setIconEvent(new DeleteIconEvent());
        BitmapStickerIcon iconZoom = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_scale_white_18dp), 3, BitmapStickerIcon.ZOOM);
        iconZoom.setIconEvent(new ZoomIconEvent());
        BitmapStickerIcon iconFlip = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.sticker_ic_flip_white_18dp), 1, BitmapStickerIcon.FLIP);
        iconFlip.setIconEvent(new FlipHorizontallyEvent());
        BitmapStickerIcon iconEdit = new BitmapStickerIcon(ContextCompat.getDrawable(getContext(), R.drawable.icon_edit), 2, BitmapStickerIcon.EDIT);
        iconEdit.setIconEvent(new FlipHorizontallyEvent());
        this.icons.clear();
        this.icons.add(iconRemove);
        this.icons.add(iconZoom);
        this.icons.add(iconFlip);
        this.icons.add(iconEdit);
    }
    ...
    public void setHandlingSticker(com.sutech.photoeditor.editor.sticker.Sticker sticker) {
    ...
    public void drawStickers(Canvas canvas) {
        ...
        for (int i2 = 0; i2 < this.stickers.size(); i2++) {
            com.sutech.photoeditor.editor.sticker.Sticker sticker = this.stickers.get(i2);
...
//                    i3 = 1;
    ...
    public void zoomAndRotateSticker(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker, @NonNull MotionEvent motionEvent) {
        float f;
        if (sticker != null) {
    ...
    public void constrainSticker(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker) {
        int width = getWidth();
    ...
    @Nullable
    public com.sutech.photoeditor.editor.sticker.Sticker findHandlingSticker() {
    ...
    public boolean isInStickerArea(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker, float f, float f2) {
        this.tmp[0] = f;
        this.tmp[1] = f2;
    ...
    public void transformSticker(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker) {
        if (sticker == null) {
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        for (int i5 = 0; i5 < this.stickers.size(); i5++) {
            com.sutech.photoeditor.editor.sticker.Sticker sticker = this.stickers.get(i5);
            if (sticker != null) {
    ...
    public void flip(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker, int i) {
        if (sticker != null) {
    ...
    public boolean replace(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker) {
        return replace(sticker, true);
    }

    public com.sutech.photoeditor.editor.sticker.Sticker getLastHandlingSticker() {
        return this.lastHandlingSticker;
    }

    public boolean replace(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker, boolean z) {
        float f;
        if (this.handlingSticker == null) {
    ...
    public boolean remove(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker) {
    ...
    @NonNull
    public StickerView addSticker(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker) {
        return addSticker(sticker, 1);
    }

    public StickerView addSticker(@NonNull final com.sutech.photoeditor.editor.sticker.Sticker sticker, final int i) {
    ...
    public void addStickerImmediately(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker, int i) {
    ...
    public void setStickerPosition(@NonNull com.sutech.photoeditor.editor.sticker.Sticker sticker, int i) {
        float f;
    ...
    @NonNull
    public float[] getStickerPoints(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker) {
        float[] fArr = new float[8];
        getStickerPoints(sticker, fArr);
        return fArr;
    }

    public void getStickerPoints(@Nullable com.sutech.photoeditor.editor.sticker.Sticker sticker, @NonNull float[] fArr) {
        if (sticker == null) {
