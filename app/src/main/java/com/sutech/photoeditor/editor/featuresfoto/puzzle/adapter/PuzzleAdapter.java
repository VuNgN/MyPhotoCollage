package com.sutech.photoeditor.editor.featuresfoto.puzzle.adapter;
...
import com.sutech.photoeditor.editor.featuresfoto.puzzle.SquarePuzzleView;
import com.sutech.photoeditor.editor.featuresfoto.puzzle.layout.slant.NumberSlantLayout;
import com.sutech.photoeditor.editor.featuresfoto.puzzle.layout.straight.NumberStraightLayout;
...
public class PuzzleAdapter extends RecyclerView.Adapter<PuzzleAdapter.PuzzleViewHolder> {
    ...
    public void onBindViewHolder(PuzzleViewHolder puzzleViewHolder, final int i) {
        ...
        puzzleViewHolder.puzzleView.setLineSize(4);
