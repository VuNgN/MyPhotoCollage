...
import com.sutech.photoeditor.editor.featuresfoto.puzzle.slant.SlantPuzzleLayout;
import com.sutech.photoeditor.editor.featuresfoto.puzzle.straight.StraightPuzzleLayout;

public class PuzzleLayoutParser {
    private PuzzleLayoutParser() {
    }

    public static com.sutech.photoeditor.editor.featuresfoto.puzzle.PuzzleLayout parse(final com.sutech.photoeditor.editor.featuresfoto.puzzle.PuzzleLayout.Info info) {
        com.sutech.photoeditor.editor.featuresfoto.puzzle.PuzzleLayout puzzleLayout;
        if (info.type == 0) {
            puzzleLayout = new StraightPuzzleLayout() {
                public com.sutech.photoeditor.editor.featuresfoto.puzzle.PuzzleLayout clone(com.sutech.photoeditor.editor.featuresfoto.puzzle.PuzzleLayout puzzleLayout) {
                    return null;
                }
