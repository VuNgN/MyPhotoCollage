...
import com.sutech.photoeditor.editor.sticker.event.StickerIconEvent;
...
public class BitmapStickerIcon extends DrawableSticker implements StickerIconEvent {
    ...
    public void onActionDown(com.sutech.photoeditor.editor.sticker.StickerView stickerView, MotionEvent motionEvent) {
        if (this.iconEvent != null) {
            this.iconEvent.onActionDown(stickerView, motionEvent);
        }
    }

    public void onActionMove(com.sutech.photoeditor.editor.sticker.StickerView stickerView, MotionEvent motionEvent) {
        if (this.iconEvent != null) {
