...
public class PuzzleView extends StickerView {
    ...
    private Map<com.sutech.photoeditor.editor.featuresfoto.puzzle.Area, PuzzlePiece> areaPieceMap;
    ...
    private com.sutech.photoeditor.editor.featuresfoto.puzzle.Line handlingLine;
    ...
    public void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        if (this.puzzlePieces.size() != 0) {
            for (int i5 = 0; i5 < this.puzzlePieces.size(); i5++) {
                ...
                com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area = this.puzzleLayout.getArea(i5);
        ...
        if (this.puzzleLayout != null) {
            ...
            if (this.initialInfo != null) {
                ...
                for (int i = 0; i < size; i++) {
                    ...
                    com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line = this.puzzleLayout.getLines().get(i);
    ...
    public void onDraw(Canvas canvas) {
        ...
        if (this.puzzleLayout != null) {
            ...
            if (this.needDrawOuterLine) {
                for (com.sutech.photoeditor.editor.featuresfoto.puzzle.Line drawLine : this.puzzleLayout.getOuterLines()) {
                    drawLine(canvas, drawLine);
                }
            }
            if (this.needDrawLine) {
                for (com.sutech.photoeditor.editor.featuresfoto.puzzle.Line drawLine2 : this.puzzleLayout.getLines()) {
    ...
    private void drawSelectedArea(Canvas canvas, PuzzlePiece puzzlePiece) {
        com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area = puzzlePiece.getArea();
        canvas.drawPath(area.getAreaPath(), this.selectedAreaPaint);
        for (com.sutech.photoeditor.editor.featuresfoto.puzzle.Line next : area.getLines()) {
    ...
    private void drawLine(Canvas canvas, com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line) {
    ...
    private void moveLine(com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line, MotionEvent motionEvent) {
        boolean z;
    ...
    private void updatePiecesInArea(com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line, MotionEvent motionEvent) {
    ...
    private com.sutech.photoeditor.editor.featuresfoto.puzzle.Line findHandlingLine() {
        if (puzzleLayout==null||puzzleLayout.getLines()==null){
            return null;
        }
