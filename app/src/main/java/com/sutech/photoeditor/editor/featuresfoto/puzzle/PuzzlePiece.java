package com.sutech.photoeditor.editor.featuresfoto.puzzle;
...
public class PuzzlePiece {
    ...
    private com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area;
    ...
    PuzzlePiece(Drawable drawable2, com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area2, Matrix matrix2) {
    ...
    public com.sutech.photoeditor.editor.featuresfoto.puzzle.Area getArea() {
        return this.area;
    }
    ...
    public boolean contains(com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line) {
    ...
    private float getMatrixScale() {
        return com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMatrixScale(this.matrix);
    }


    public float getMatrixAngle() {
        return com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMatrixAngle(this.matrix);
    }
    ...
    public boolean canFilledArea() {
        return com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMatrixScale(this.matrix) >= com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMinMatrixScale(this);
    }
    ...
    public void postRotate(float f) {
        ...
        float minMatrixScale = com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMinMatrixScale(this);
        ...
        if (!com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.judgeIsImageContainsBorder(this, getMatrixAngle())) {
            float[] calculateImageIndents = com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.calculateImageIndents(this);
    ...
    public void fillArea(View view, boolean z) {
        if (!isFilledArea()) {
            ...
            final float minMatrixScale = com.sutech.photoeditor.editor.featuresfoto.puzzle.MatrixUtils.getMinMatrixScale(this);
    ...
    public void updateWith(MotionEvent motionEvent, com.sutech.photoeditor.editor.featuresfoto.puzzle.Line line) {
        float x = (motionEvent.getX() - this.previousMoveX) / 2.0f;
        float y = (motionEvent.getY() - this.previousMoveY) / 2.0f;
        if (!canFilledArea()) {
            com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area2 = getArea();
        ...
        if (line.direction() == com.sutech.photoeditor.editor.featuresfoto.puzzle.Line.Direction.HORIZONTAL) {
            translate(0.0f, y);
        } else if (line.direction() == Line.Direction.VERTICAL) {
            translate(x, 0.0f);
        }
        RectF currentDrawableBounds = getCurrentDrawableBounds();
        com.sutech.photoeditor.editor.featuresfoto.puzzle.Area area3 = getArea();
