...
public class PhotoEditor implements BrushViewChangeListener {
    ...
    private void addViewToParent(View view, com.sutech.photoeditor.widget.customview.photo.ViewType viewType) {
    ...
    private void viewUndo(View view, com.sutech.photoeditor.widget.customview.photo.ViewType viewType) {
        ...
        if (this.addedViews.size() > 0) {
            ...
            if (!(view instanceof BrushDrawingView)) {
                ...
                if (this.mOnPhotoEditorListener != null) {
                    ...
                    if (tag != null && (tag instanceof com.sutech.photoeditor.widget.customview.photo.ViewType)) {
                        this.mOnPhotoEditorListener.onRemoveViewListener((com.sutech.photoeditor.widget.customview.photo.ViewType) tag, this.addedViews.size());
                    }
                }
    ...
    public boolean redo() {
        if (this.redoViews.size() > 0) {
            ...
            if (!(view instanceof BrushDrawingView)) {
                ...
                this.addedViews.add(view);
                Object tag = view.getTag();
                if (!(this.mOnPhotoEditorListener == null || tag == null || !(tag instanceof com.sutech.photoeditor.widget.customview.photo.ViewType))) {
                    this.mOnPhotoEditorListener.onAddViewListener((com.sutech.photoeditor.widget.customview.photo.ViewType) tag, this.addedViews.size());
                }
                        ...
                        try {
                            ...
                            if (PhotoEditor.this.parentView != null) {
                                ...
                                if (saveSettings.isTransparencyEnabled()) {
                                    bitmap = com.sutech.photoeditor.widget.customview.photo.BitmapUtil.removeTransparency(PhotoEditor.this.parentView.getDrawingCache());
                                } else {
    ...
    public void saveStickerAsBitmap(@NonNull SaveSettings saveSettings, @NonNull OnSaveBitmap onSaveBitmap) {
        ...
        if (saveSettings.isTransparencyEnabled()) {
            Log.e(TAG, "saveStickerAsBitmap: isTransparencyEnabled" );
            bitmap = com.sutech.photoeditor.widget.customview.photo.BitmapUtil.removeTransparency(this.parentView.getDrawingCache());
        } else {
            Log.e(TAG, "saveStickerAsBitmap: noTransparencyEnabled" );
    ...
    public void onViewAdd(BrushDrawingView brushDrawingView2) {
        ...
        if (this.mOnPhotoEditorListener != null) {
            this.mOnPhotoEditorListener.onAddViewListener(com.sutech.photoeditor.widget.customview.photo.ViewType.BRUSH_DRAWING, this.addedViews.size());
        }
    }
    ...
    public void onViewRemoved(BrushDrawingView brushDrawingView2) {
        ...
        if (this.mOnPhotoEditorListener != null) {
            this.mOnPhotoEditorListener.onRemoveViewListener(this.addedViews.size());
            this.mOnPhotoEditorListener.onRemoveViewListener(com.sutech.photoeditor.widget.customview.photo.ViewType.BRUSH_DRAWING, this.addedViews.size());
        }
    }

    public void onStartDrawing() {
        if (this.mOnPhotoEditorListener != null) {
            this.mOnPhotoEditorListener.onStartViewChangeListener(com.sutech.photoeditor.widget.customview.photo.ViewType.BRUSH_DRAWING);
        }
    }
