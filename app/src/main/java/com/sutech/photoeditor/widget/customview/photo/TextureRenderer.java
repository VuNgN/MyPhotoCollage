...
class TextureRenderer implements GLSurfaceView.Renderer {
    ...
    public void init() {
        this.mProgram = com.sutech.photoeditor.widget.customview.photo.GLToolbox.createProgram(VERTEX_SHADER, FRAGMENT_SHADER);
    ...
    public void renderTexture(int i) {
        ...
        com.sutech.photoeditor.widget.customview.photo.GLToolbox.checkGlError("glUseProgram");
        GLES20.glViewport(0, 0, this.mViewWidth, this.mViewHeight);
        com.sutech.photoeditor.widget.customview.photo.GLToolbox.checkGlError("glViewport");
        ...
        com.sutech.photoeditor.widget.customview.photo.GLToolbox.checkGlError("vertex attribute setup");
        GLES20.glActiveTexture(33984);
        com.sutech.photoeditor.widget.customview.photo.GLToolbox.checkGlError("glActiveTexture");
        GLES20.glBindTexture(3553, i);
        com.sutech.photoeditor.widget.customview.photo.GLToolbox.checkGlError("glBindTexture");
